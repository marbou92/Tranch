...
func apply_tier(tier: Tier):
	...
	match tier:
		Tier.LOW: _apply_low()
		Tier.MEDIUM: _apply_medium()
		Tier.HIGH: _apply_high()
...
func _set_texture_filter(high_quality: bool):
	var filter = BaseMaterial3D.TEXTURE_FILTER_LINEAR_WITH_MIPMAPS if high_quality \
...
func get_draw_distance() -> float:
	match current_tier:
		Tier.LOW: return 40.0
		Tier.MEDIUM: return 80.0
		Tier.HIGH: return 200.0
		_: return 80.0

func get_max_texture_resolution() -> int:
	match current_tier:
		Tier.LOW: return 512
		Tier.MEDIUM: return 1024
		Tier.HIGH: return 4096
		_: return 1024
...
func get_lod_level() -> int:
	...
	match current_tier:
		Tier.LOW: return 2  # LOD2 always
		Tier.MEDIUM: return 1  # LOD1 close, LOD2 far
		Tier.HIGH: return 0  # LOD0 always
		_: return 1

func get_memory_strategy() -> String:
	match current_tier:
		Tier.LOW: return "single_zone"
		Tier.MEDIUM: return "current_plus_adjacent"
		Tier.HIGH: return "current_plus_all_adjacent"
		_: return "current_plus_adjacent"
